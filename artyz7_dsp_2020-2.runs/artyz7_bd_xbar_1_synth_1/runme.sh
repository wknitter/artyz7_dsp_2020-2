...
HD_PWD='/home/parallels/artyz7_dsp_2020-2/artyz7_dsp_2020-2.runs/artyz7_bd_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log artyz7_bd_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source artyz7_bd_xbar_1.tcl
