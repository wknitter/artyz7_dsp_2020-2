...
HD_PWD='/home/parallels/artyz7_dsp_2020-2/artyz7_dsp_2020-2.runs/synth_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log artyz7_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source artyz7_bd_wrapper.tcl
