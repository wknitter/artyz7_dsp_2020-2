...
HD_PWD='/home/parallels/artyz7_dsp_2020-2/artyz7_dsp_2020-2.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log artyz7_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source artyz7_bd_wrapper.tcl -notrace
